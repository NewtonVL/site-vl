    ...
    <>
      ...
      <header
        className={`sticky top-0 z-40 w-full transition-all duration-300 ${
          scrolled
            ? 'bg-white/95 backdrop-blur-md shadow-subtle border-b border-zinc-200/80 py-3'
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-4">
              <a
                href="#contato"
                className="inline-flex items-center gap-2 text-sm font-semibold text-zinc-900 bg-zinc-50 hover:bg-brand-50 hover:text-brand border border-zinc-200 hover:border-brand-200 px-4 py-2.5 rounded-full transition-all duration-200 shadow-sm"
              >
        ...
        {mobileMenuOpen && (
          <div
            ...
            className="md:hidden fixed inset-x-0 top-[65px] bg-white/98 backdrop-blur-xl border-b border-zinc-200 shadow-xl transition-all duration-200 animate-in fade-in slide-in-from-top-4"
          >
            <div className="px-5 pt-4 pb-6 space-y-3">
              ...
              <div className="pt-4 border-t border-zinc-100">
                <a
                  href="#contato"
                  onClick={handleLinkClick}
                  className="flex items-center justify-center gap-2 w-full text-center px-4 py-3 rounded-lg text-sm font-semibold text-white bg-brand hover:bg-brand-600 transition-colors shadow-sm"
                >
